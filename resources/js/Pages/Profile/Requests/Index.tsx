...
interface RequestHistoryProps extends PageProps {
    requests: PendingRequest[];
}

export default function Index({ auth, requests }: RequestHistoryProps) {
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400">
                                    All your profile update and account deletion requests.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="p-6">
                            {requests.length === 0 ? (
                                <div className="text-center py-12">
                                    ...
                                    <p className="text-gray-500 dark:text-gray-400 text-lg">No request history found</p>
                                </div>
                            ) : (
